...
export class FormModel{
    ...
    async update(fields = {}) {
        ...
        await putDocument(FIRESTORE_CONSTANTS.SETTINGS_COLLECTION, FIRESTORE_CONSTANTS.FORM_DOCUMENT, dataToUpdate);
    ...
    static async findDocument() {
        const doc = await getDocument(FIRESTORE_CONSTANTS.SETTINGS_COLLECTION, FIRESTORE_CONSTANTS.FORM_DOCUMENT);
